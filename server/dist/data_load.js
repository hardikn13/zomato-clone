...
const uri = "mongodb+srv://2021kucp1080:K3p8eZXlD85CSoaz@zomato-clone.ezu45.mongodb.net/";
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const restaurants = jsonData.flatMap((item) => {
                var _a;
                return (_a = item.restaurants) === null || _a === void 0 ? void 0 : _a.map((r) => {
                    const restaurant = r.restaurant;
                    // Remove specified fields
                    const { R, zomato_events, events_url, establishment_types } = restaurant, cleanedRestaurant = __rest(restaurant, ["R", "zomato_events", "events_url", "establishment_types"]);
            ...
            try {
                ...
                console.log(`${result.insertedCount} documents from ${path_1.default.basename(filePath)} were inserted.`);
            }
            catch (error) {
                if (error.writeErrors) {
                    console.log(`${error.writeErrors.length} duplicate documents from ${path_1.default.basename(filePath)} were ignored.`);
                }
                else {
                    throw error;
                }
